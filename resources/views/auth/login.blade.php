...
<head>
    ...
    <style>
    body {
  background-image: url({{asset('img/adminbg.jpg')}});
...
<div id="loginbox">
    <form id="loginform" class="form-vertical" method="POST" action="{{ route('login') }}">
        ...
        <div class="control-group normal_text"> <h3><img src="{{asset('img/Rslogo.png')}}" alt="Logo" height="50px" width="60px" /></h3></div>
