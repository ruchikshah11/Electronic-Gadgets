            ...
            <div class="col-sm-5">
                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                    <a href="{{url('products/large',$detail_product->image)}}">
                        <img src="{{url('products/small',$detail_product->image)}}" alt="" id="dynamicImage " height="500px" width="450px"/>
                    </a>
                </div>
                ...
                <form action="{{route('addToCart')}}" method="post" role="form">
                    ...
                    <div class="product-information"><!--/product-information-->
                        ...
                        <span>
                        	...
                        	<option value="">Select Vairant</option>
                        ...
                        <span>
                            <span id="dynamic_price">IND ₹ {{$detail_product->price}}</span>
                            <label>Quantity</label>
                            <input type="text" name="quantity" value="1" id="inputStock"/><br/>
                            
                            <label> In Stock </label>
                            <input type="text" name="stock" value="{{$totalStock}}" id="inputStock" readonly><br/>
                            @if($totalStock>0)
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="reviews" >
                    <div class="col-sm-12">
                        ...
                        <p>“If you do build a great experience, customers tell each other about that. Word of mouth is very powerful.” &nbsp; - Ruchik Shah</p>
